...
Version  : 2.8
Release  : 28
URL      : https://github.com/linux-nvme/nvme-cli/archive/v2.8/nvme-cli-2.8.tar.gz
Source0  : https://github.com/linux-nvme/nvme-cli/archive/v2.8/nvme-cli-2.8.tar.gz
...
%prep
%setup -q -n nvme-cli-2.8
cd %{_builddir}/nvme-cli-2.8
pushd ..
cp -a nvme-cli-2.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707924025
unset LD_AS_NEEDED
