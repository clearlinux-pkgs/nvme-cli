...
Version  : 1.3
Release  : 7
URL      : https://github.com/linux-nvme/nvme-cli/archive/v1.3.tar.gz
Source0  : https://github.com/linux-nvme/nvme-cli/archive/v1.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1495134948
