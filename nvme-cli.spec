...
Source0  : https://github.com/linux-nvme/nvme-cli/archive/v2.11/nvme-cli-2.11.tar.gz
...
%prep
%setup -q -n nvme-cli-2.11
cd %{_builddir}/nvme-cli-2.11
pushd ..
cp -a nvme-cli-2.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730391699
unset LD_AS_NEEDED
