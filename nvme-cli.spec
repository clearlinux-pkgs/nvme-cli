...
Source0  : https://github.com/linux-nvme/nvme-cli/archive/v2.13/nvme-cli-2.13.tar.gz
...
%prep
%setup -q -n nvme-cli-2.13
cd %{_builddir}/nvme-cli-2.13
pushd ..
cp -a nvme-cli-2.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744382791
unset LD_AS_NEEDED
