...
Version  : 1.4
Release  : 8
URL      : https://github.com/linux-nvme/nvme-cli/archive/v1.4.tar.gz
Source0  : https://github.com/linux-nvme/nvme-cli/archive/v1.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1506121620
