...
Source0  : https://github.com/linux-nvme/nvme-cli/archive/v2.9.1/nvme-cli-2.9.1.tar.gz
...
%prep
%setup -q -n nvme-cli-2.9.1
cd %{_builddir}/nvme-cli-2.9.1
pushd ..
cp -a nvme-cli-2.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715009194
unset LD_AS_NEEDED
